...
language = 
    ...
    .invalid-locale = Chữ viết tắt ngôn ngữ được chỉ định không hợp lệ
    Bạn có thể chọn ví dụ: { $locales }
    .already-set = Ngôn ngữ hiện tại đã được đặt thành { $locale }
    .language-set = Ngôn ngữ đã được đặt thành công thành { $locale }